...
aleatorio entre 0 y 100, y luego ir pidiendo numeros indicando "es mayor" o "es menor"
segun lo sea respecto de N. El proceso termina cuando el usuario acierta y mostramos
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            if(numero < aleatorio){
                ...
                System.out.println("¡¡¡Felicitaciones, adivinaste el nro!!!");
            }
            conteo++;
